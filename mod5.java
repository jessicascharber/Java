/**
 * stockTracker1J - This class extends Frame and implements ActionListener.
 *
...
/**
 * This abstract class provides a list of variables and an abstract method.
 *
 * @author Jessica Scharber
 * @version (10/21/2018)
 *
...
public abstract class abstractUser1J
{

    String fName, lName, stockList, userList;
    int userId, userIdS;

    public abstract void userJAb();
}
/**
 * This class extends abstractUser1J and is called by class stockTracker1J for use of a printArray method.
 *
 * @author (Jessica Scharber)
 * @version (10/21/18)
 */
...
public class userJ extends abstractUser1J
{
   public void userJAb()
   {
       ...
       System.out.println("Scharber");

       System.out.println("Resin,Bitcoin,SolarE");
    }
       ...
       public static void userArray()
            {
               ...
               userArray[1] = "Jessica Scharber";

               userArray[2] = "Stock: Resin";

               userArray[3] = "Stock: Bitcoin";

               userArray[4] = "Stock: SolarE";
...
/**
 * This code will facilitate a connection to a database.
 *
 * @author Jessica Scharber
 * @version 10/28/18
 */
