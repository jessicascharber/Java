...
public class stockTracker extends Frame implements ActionListener
{
	public stockTracker()
	{
...
// I have left some code examples in this program as a blueprint to refresh my memory.
		...
		if (arg == "Add Stock")
				{
					...
					// output
					JOptionPane.showMessageDialog(null, "The stock " + stockName + " has been added to your portfolio." +
					".", "Stock Added",JOptionPane.PLAIN_MESSAGE);
	...
	public static void main(String args[])
	{
		...
		stockTracker f = new stockTracker();
